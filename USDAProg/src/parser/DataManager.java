...
public class DataManager {
    ...
    /**
     * Adds a food item into the appropriate files, and loads it into the data structure
     *
    ...
    /**
     * Adds a Formattable into a file, using its .getFormat() to get the file formatted string
     *
