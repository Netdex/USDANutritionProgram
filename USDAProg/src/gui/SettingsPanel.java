...
public class SettingsPanel extends JPanel {
	...
	public SettingsPanel(PanelManager pManager) {
		...
		content.setBackground(GUI.BACKGROUND_BLUE);

		// gender selection
		JPanel genderLine = new JPanel();
		genderLine.setLayout(new FlowLayout(FlowLayout.LEFT));
		genderLine.setBackground(GUI.BACKGROUND_BLUE);
		...
		genderSelector.setBackground(GUI.BACKGROUND_BLUE);
		...
		weightLine.setBackground(GUI.BACKGROUND_BLUE);
		...
		weightUnitSelector.setBackground(GUI.BACKGROUND_BLUE);
		...
		heightLine.setBackground(GUI.BACKGROUND_BLUE);
		...
		heightUnitSelector.setBackground(GUI.BACKGROUND_BLUE);
		...
		ageLine.setBackground(GUI.BACKGROUND_BLUE);
		...
		exerciseLine.setBackground(GUI.BACKGROUND_BLUE);
